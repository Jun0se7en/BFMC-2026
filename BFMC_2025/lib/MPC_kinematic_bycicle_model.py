...
class KinematicBicycleModel:
    ...
    def discrete_kbm(self, velocity: float, steering: float, x: float, y: float, heading: float, acceleration: float, dt: float):
        ...
        state_x = x + velocity * math.cos(new_heading) * dt
        state_y = y + velocity * math.sin(new_heading) * dt
