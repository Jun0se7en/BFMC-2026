...
def save_checkpoint(epoch, name, model,ema, optimizer, output_dir, filename, is_best=False):
    model_state = model.module.state_dict() if is_parallel(model) else model.state_dict()
    ema_state = ema.module.state_dict() if is_parallel(ema) else ema.state_dict()
    checkpoint = {
            'epoch': epoch,
            'model': name,
